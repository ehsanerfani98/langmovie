...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <a href="{{ route('user.subscript.plans') }}" class="btn btn-sm btn-light mb-3">خرید اشتراک</a>
                    ...
                    <div class="card card-subscription {{ $subscription->status == 'expired' ? 'disable' : '' }}">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <div
                                    class="d-flex justify-content-between align-items-center flex-column gap-2 flex-lg-row">
                                    @if ($subscription->status == 'active')
                                        <a class="status-badge expired fs-r"
                                            href="{{ route('user.subscriptions.expire') }}">منقضی کن</a>
                                    @endif
                            ...
                            {{-- <div class="mt-3 pt-2 border-top">
                                <div class="d-flex justify-content-between align-items-center mt-2">
                                    <div>
                                        <p class="mb-1 text-muted small fs-r">
                                            <i class="bi bi-search text-success"></i> جستجوی روزانه
                                        </p>
                                        <p class="mb-0 fw-bold fs-r" style="font-size: 13px">
                                            {{ $subscription->daily_search_limit }} جستجو
                                        </p>
                                    </div>
                                    <div>
                                        <p class="mb-1 text-muted small fs-r">
                                            <i class="bi bi-film text-warning"></i> نمایش سکانس در هر جستجو
                                        </p>
                                        <p class="mb-0 fw-bold fs-r" style="font-size: 13px">
                                            {{ $subscription->daily_segment_limit }} سکانس
                                        </p>
                                    </div>
                                </div>
                            </div> --}}
