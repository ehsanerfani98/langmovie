        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <input type="hidden" name="payment_gateway_type" id="payment_gateway_type" value="zarinpal">
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <select name="payment_gateway_status" class="form-control" id="payment_gateway_status">
                                    <option value="1" {{ old('payment_gateway_status', get_setting_collection($settings, 'payment_gateway_status')) == '1' ? 'selected' : ''}}>حالت آزمایشی</option>
                                    <option value="0" {{ old('payment_gateway_status', get_setting_collection($settings, 'payment_gateway_status')) == '0' ? 'selected' : '' }}>حالت واقعی</option>
                                </select>
                            </div>
                            <div class="col-lg-3 mb-4">
                                <label for="percent_include">واحد ارز</label>
                                <select name="payment_gateway_unit" class="form-control" id="payment_gateway_unit">
                                    <option value="IRR" {{ old('payment_gateway_unit', get_setting_collection($settings, 'payment_gateway_unit')) == 'IRR' ? 'selected' : '' }}>ریال</option>
                                    <option value="IRT" {{ old('payment_gateway_unit', get_setting_collection($settings, 'payment_gateway_unit')) == 'IRT' ? 'selected' : '' }}>تومان</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <select name="sms_status" class="form-control" id="sms_status">
                                    <option value="1" {{ old('sms_status', get_setting_collection($settings, 'sms_status')) == '1' ? 'selected' : ''}}>حالت آزمایشی</option>
                                    <option value="0" {{ old('sms_status', get_setting_collection($settings, 'sms_status')) == '0' ? 'selected' : '' }}>حالت واقعی</option>
                                </select>
                            </div>
                        </div>
                    </div>
