...
class SubscriptionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'daily_search_limit' => 'required|integer|min:1',
            'daily_segment_limit' => 'required|integer|min:1',
        ]);
        ...
        Subscription::create([
            ...
            'daily_search_limit' => $request->daily_search_limit,
            'daily_segment_limit' => $request->daily_segment_limit,
